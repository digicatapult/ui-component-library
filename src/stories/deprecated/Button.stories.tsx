...
export const dangerButton = (args: StrictButtonStyleProps) => (
  <ButtonDanger {...args}>Danger Button</ButtonDanger>
)
export const outlineButton = (args: StrictButtonStyleProps) => (
  <ButtonOutline {...args}>Outline Button</ButtonOutline>
)
