...
export function SingleSelection(): JSX.Element {
  ...
  return (
    <>
      ...
      <p>
        This pattern has a single section with the selected value shown in the
        button
      </p>
...
export function SingleSelectionWithPlaceholder(): JSX.Element {
  ...
  return (
    <>
      ...
      <p>
        This pattern has a placeholder in menu button when no value is selected
        yet
      </p>
...
export function MultipleSelection(): JSX.Element {
  ...
  return (
    <>
      ...
      <p>
        ActionMenu with multiple selection is not seen in production. You see
        SelectPanel used instead.
      </p>
  ...
  return (
    <>
      ...
      <p>
        ...
        appears inside a ActionMenu for selection view options in Memex
      </p>
