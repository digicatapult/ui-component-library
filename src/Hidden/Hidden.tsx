...
export const Hidden = ({ on: hiddenViewports, children }: HiddenProps) => {
  ...
  if (
    isNarrowViewport &&
    (hiddenViewports === 'narrow' || hiddenViewports.indexOf('narrow') > -1)
  ) {
    show = false
  } else if (
    isRegularViewport &&
    (hiddenViewports === 'regular' || hiddenViewports.indexOf('regular') > -1)
  ) {
    show = false
  } else if (
    isWideViewport &&
    (hiddenViewports === 'wide' || hiddenViewports.indexOf('wide') > -1)
  ) {
    show = false
  }
