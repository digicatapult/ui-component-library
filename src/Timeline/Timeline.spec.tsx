        ...
        .create(
          <Timeline>
            <Timeline.Item
              ...
              checked={false}
            ></Timeline.Item>
            <Timeline.Item title="timeline-item-complete" checked={true}>
              <h1>header</h1>
            </Timeline.Item>
          </Timeline>,
        )
      ...
      const tree = renderer
        .create(
          <Timeline name="default">
            <Timeline.Item title="timeline-item-1" checked={true}>
            ...
            <Timeline.Item title="timeline-item-2" checked={true}>
              <h2>header</h2>
              <p>
